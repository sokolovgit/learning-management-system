...
<template>
  ...
  <div class="mt-5 rounded-md ring-gray-300 sm:mx-auto sm:w-full sm:max-w-sm ring-1 ring-offset-8 ">
      ...
      <div>
        ...
        <div class="mt-2">
          <input
            ...
            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
          />
          <span v-if="v$.email.$invalid && v$.email.$dirty" class="text-red-500 text-sm">Enter a valid email</span>
        </div>
      </div>
